#/Users/agusferfel/Desktop/TFGestad/TFG/models/DCEC-master
...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset', default='mnist', choices=['mnist', 'usps', 'mnist-test', 'fashion', 'fashion-test'])
    ...
    parser.add_argument('--cae_weights', default=None, help='This argument must be given (string format)')
    ...
    history_dcec = dcec.fit(x, y=y, tol=args.tol, maxiter=args.maxiter,
